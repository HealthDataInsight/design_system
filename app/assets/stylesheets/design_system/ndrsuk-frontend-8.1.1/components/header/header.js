...
class Header {
  constructor() {
    ...
    this.navigation = document.querySelector('.ndrsuk-navigation')
    this.navigationList = document.querySelector('.ndrsuk-header__navigation-list')
    this.mobileMenu = document.createElement('ul')
    this.mobileMenuToggleButton = document.querySelector('.ndrsuk-header__menu-toggle')
    this.mobileMenuCloseButton = document.createElement('button')
    this.mobileMenuContainer = document.querySelector('.ndrsuk-mobile-menu-container')
    this.breakpoints = []
  ...
  setupMobileMenu() {
    ...
    this.mobileMenu.classList.add('ndrsuk-header__drop-down', 'ndrsuk-header__drop-down--hidden')
  }
  ...
  closeMobileMenu() {
    this.menuIsOpen = false
    this.mobileMenu.classList.add('ndrsuk-header__drop-down--hidden')
  ...
  openMobileMenu() {
    ...
    this.mobileMenu.classList.remove('ndrsuk-header__drop-down--hidden')
  ...
  updateNavigation() {
    ...
    if (availableSpace < this.breakpoints[itemsVisible - 1]) {
      this.mobileMenuToggleButton.classList.add('ndrsuk-header__menu-toggle--visible')
      this.mobileMenuContainer.classList.add('ndrsuk-mobile-menu-container--visible')
      if (itemsVisible === 2) {
        return
      }
    ...
    if (!this.mobileMenu.children.length) {
      this.mobileMenuToggleButton.classList.remove('ndrsuk-header__menu-toggle--visible')
      this.mobileMenuContainer.classList.remove('ndrsuk-mobile-menu-container--visible')
    }
