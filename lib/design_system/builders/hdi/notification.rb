      ...
      class Notification < ::DesignSystem::Builders::Generic::Notification
        ...
        def icon_alert_content
          content_tag(:svg,
                      ...
                      class: "#{brand}-notification-banner-icon", viewBox: '0 0 20 20', fill: 'currentColor', aria_hidden: 'true', stroke_linecap: 'round', stroke_linejoin: 'round', stroke_width: '2')
        end
        ...
        def icon_notice_content
          content_tag(:svg,
                      ...
                      class: "#{brand}-notification-banner-icon", viewBox: '0 0 20 20',
