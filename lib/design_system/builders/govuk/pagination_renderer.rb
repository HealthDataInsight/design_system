      ...
      class PaginationRenderer < ::DesignSystem::Builders::Generic::PaginationRenderer
        ...
        def page_number(page)
          if page == current_page
            tag(:li,
                tag(:a, page, class: 'govuk-link govuk-pagination__link', href: '#',
                              aria: { label: "Page #{page}", current: 'page' }),
                class: 'govuk-pagination__item govuk-pagination__item--current')
          else
            tag(:li,
                tag(:a, page, class: 'govuk-link govuk-pagination__link', href: url(page),
        ...
        def govuk_icon(type)
          ...
          when 'next'
            ...
            height="13" width="15" aria-hidden="true" focusable="false" viewBox="0 0 15 13">
            <path d="m8.107-0.0078125-1.4136 1.414
            4.2926 4.293h-12.986v2h12.896l-4.1855 3.9766 1.377 1.4492 6.7441-6.4062-6.7246-6.7266z"></path>
            </svg>'
          end
        end
      end
